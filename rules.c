...
{
   int i,j,k, nMethylated=0, nUnmodified=0, nHp1Free=0, nHp1Occupied=0, nNeigh=0, nCanContact=0, nHp1OccupiedMet=0,nHp1OccupiedUnmet=0;
   ...
   {    
	...
	{
           if (p->kMethHp1Unbind==0 || met[i]==0) nHp1Occupied++;	// rule 4
...
{
   int i,j,k,l,ok=0, chk=0, isInContact=0;
